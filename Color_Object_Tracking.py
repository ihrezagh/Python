...
cv2.createTrackbar("HUE Max","HSV",61,179,empty)
cv2.createTrackbar("SAT Min","HSV",64,255,empty)
cv2.createTrackbar("SAT Max","HSV",255,255,empty)
cv2.createTrackbar("VALUE Min","HSV",47,255,empty)
...
cv2.createTrackbar("Area","Parameters",15031,30000,empty)
